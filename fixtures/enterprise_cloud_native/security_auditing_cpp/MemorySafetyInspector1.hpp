...
namespace Navigator::Security::Module1 {

struct MemoryLeakReport1 {
...
class MemorySafetyInspector1 {
private:
    std::unordered_map<void*, MemoryLeakReport1> activeAllocations;
public:
    MemorySafetyInspector1() = default;

    void recordAllocation(void* ptr, const std::string& site, size_t bytes) {
        activeAllocations[ptr] = MemoryLeakReport1{
