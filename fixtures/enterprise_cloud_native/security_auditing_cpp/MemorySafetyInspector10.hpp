...
namespace Navigator::Security::Module10 {

struct MemoryLeakReport10 {
...
class MemorySafetyInspector10 {
private:
    std::unordered_map<void*, MemoryLeakReport10> activeAllocations;
public:
    MemorySafetyInspector10() = default;

    void recordAllocation(void* ptr, const std::string& site, size_t bytes) {
        activeAllocations[ptr] = MemoryLeakReport10{
