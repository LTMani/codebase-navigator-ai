...
namespace Navigator::Security::Module11 {

struct MemoryLeakReport11 {
...
class MemorySafetyInspector11 {
private:
    std::unordered_map<void*, MemoryLeakReport11> activeAllocations;
public:
    MemorySafetyInspector11() = default;

    void recordAllocation(void* ptr, const std::string& site, size_t bytes) {
        activeAllocations[ptr] = MemoryLeakReport11{
