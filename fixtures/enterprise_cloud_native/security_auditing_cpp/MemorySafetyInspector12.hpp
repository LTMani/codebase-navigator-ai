...
namespace Navigator::Security::Module12 {

struct MemoryLeakReport12 {
...
class MemorySafetyInspector12 {
private:
    std::unordered_map<void*, MemoryLeakReport12> activeAllocations;
public:
    MemorySafetyInspector12() = default;

    void recordAllocation(void* ptr, const std::string& site, size_t bytes) {
        activeAllocations[ptr] = MemoryLeakReport12{
