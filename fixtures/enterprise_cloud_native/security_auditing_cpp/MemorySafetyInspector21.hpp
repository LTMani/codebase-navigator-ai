...
namespace Navigator::Security::Module21 {

struct MemoryLeakReport21 {
...
class MemorySafetyInspector21 {
private:
    std::unordered_map<void*, MemoryLeakReport21> activeAllocations;
public:
    MemorySafetyInspector21() = default;

    void recordAllocation(void* ptr, const std::string& site, size_t bytes) {
        activeAllocations[ptr] = MemoryLeakReport21{
