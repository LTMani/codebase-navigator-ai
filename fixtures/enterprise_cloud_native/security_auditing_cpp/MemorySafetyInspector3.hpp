...
namespace Navigator::Security::Module3 {

struct MemoryLeakReport3 {
...
class MemorySafetyInspector3 {
private:
    std::unordered_map<void*, MemoryLeakReport3> activeAllocations;
public:
    MemorySafetyInspector3() = default;

    void recordAllocation(void* ptr, const std::string& site, size_t bytes) {
        activeAllocations[ptr] = MemoryLeakReport3{
