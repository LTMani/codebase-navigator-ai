...
namespace Navigator::Security::Module4 {

struct MemoryLeakReport4 {
...
class MemorySafetyInspector4 {
private:
    std::unordered_map<void*, MemoryLeakReport4> activeAllocations;
public:
    MemorySafetyInspector4() = default;

    void recordAllocation(void* ptr, const std::string& site, size_t bytes) {
        activeAllocations[ptr] = MemoryLeakReport4{
