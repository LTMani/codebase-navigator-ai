...
namespace Navigator::Security::Module6 {

struct MemoryLeakReport6 {
...
class MemorySafetyInspector6 {
private:
    std::unordered_map<void*, MemoryLeakReport6> activeAllocations;
public:
    MemorySafetyInspector6() = default;

    void recordAllocation(void* ptr, const std::string& site, size_t bytes) {
        activeAllocations[ptr] = MemoryLeakReport6{
