...
namespace Navigator::Security::Module9 {

struct MemoryLeakReport9 {
...
class MemorySafetyInspector9 {
private:
    std::unordered_map<void*, MemoryLeakReport9> activeAllocations;
public:
    MemorySafetyInspector9() = default;

    void recordAllocation(void* ptr, const std::string& site, size_t bytes) {
        activeAllocations[ptr] = MemoryLeakReport9{
