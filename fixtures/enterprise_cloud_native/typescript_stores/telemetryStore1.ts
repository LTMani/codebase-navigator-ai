// Enterprise State Slice & Metric Store 1
export interface TelemetryEventPayload1 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore1 {
  private events: TelemetryEventPayload1[] = [];

  public recordEvent(event: TelemetryEventPayload1): void {
