// Enterprise State Slice & Metric Store 11
export interface TelemetryEventPayload11 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore11 {
  private events: TelemetryEventPayload11[] = [];

  public recordEvent(event: TelemetryEventPayload11): void {
