// Enterprise State Slice & Metric Store 12
export interface TelemetryEventPayload12 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore12 {
  private events: TelemetryEventPayload12[] = [];

  public recordEvent(event: TelemetryEventPayload12): void {
