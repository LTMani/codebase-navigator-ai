// Enterprise State Slice & Metric Store 13
export interface TelemetryEventPayload13 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore13 {
  private events: TelemetryEventPayload13[] = [];

  public recordEvent(event: TelemetryEventPayload13): void {
