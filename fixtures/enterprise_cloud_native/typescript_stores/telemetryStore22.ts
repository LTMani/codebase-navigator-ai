// Enterprise State Slice & Metric Store 22
export interface TelemetryEventPayload22 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore22 {
  private events: TelemetryEventPayload22[] = [];

  public recordEvent(event: TelemetryEventPayload22): void {
