// Enterprise State Slice & Metric Store 25
export interface TelemetryEventPayload25 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore25 {
  private events: TelemetryEventPayload25[] = [];

  public recordEvent(event: TelemetryEventPayload25): void {
