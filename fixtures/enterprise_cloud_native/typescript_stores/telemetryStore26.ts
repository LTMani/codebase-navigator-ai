// Enterprise State Slice & Metric Store 26
export interface TelemetryEventPayload26 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore26 {
  private events: TelemetryEventPayload26[] = [];

  public recordEvent(event: TelemetryEventPayload26): void {
