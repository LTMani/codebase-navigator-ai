// Enterprise State Slice & Metric Store 3
export interface TelemetryEventPayload3 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore3 {
  private events: TelemetryEventPayload3[] = [];

  public recordEvent(event: TelemetryEventPayload3): void {
