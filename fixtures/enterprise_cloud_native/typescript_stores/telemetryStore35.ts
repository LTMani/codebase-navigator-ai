// Enterprise State Slice & Metric Store 35
export interface TelemetryEventPayload35 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore35 {
  private events: TelemetryEventPayload35[] = [];

  public recordEvent(event: TelemetryEventPayload35): void {
