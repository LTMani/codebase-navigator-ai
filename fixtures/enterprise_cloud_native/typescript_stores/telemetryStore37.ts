// Enterprise State Slice & Metric Store 37
export interface TelemetryEventPayload37 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore37 {
  private events: TelemetryEventPayload37[] = [];

  public recordEvent(event: TelemetryEventPayload37): void {
