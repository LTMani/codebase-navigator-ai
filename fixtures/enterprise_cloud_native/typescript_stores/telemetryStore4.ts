// Enterprise State Slice & Metric Store 4
export interface TelemetryEventPayload4 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore4 {
  private events: TelemetryEventPayload4[] = [];

  public recordEvent(event: TelemetryEventPayload4): void {
