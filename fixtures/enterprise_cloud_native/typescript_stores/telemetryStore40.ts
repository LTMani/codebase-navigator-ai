// Enterprise State Slice & Metric Store 40
export interface TelemetryEventPayload40 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore40 {
  private events: TelemetryEventPayload40[] = [];

  public recordEvent(event: TelemetryEventPayload40): void {
