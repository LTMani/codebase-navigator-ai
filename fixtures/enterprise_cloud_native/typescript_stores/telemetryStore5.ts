// Enterprise State Slice & Metric Store 5
export interface TelemetryEventPayload5 {
  id: string;
  serviceName: string;
  durationMs: number;
  isSuccess: boolean;
...
export class TelemetryStateStore5 {
  private events: TelemetryEventPayload5[] = [];

  public recordEvent(event: TelemetryEventPayload5): void {
