...
class AnalyticsEngine10:
    """Engine for processing telemetry stream 10."""

    def __init__(self, damping_factor: float = 0.85):
        self.damping_factor = damping_factor
        self._records: List[AnalyticsRecord10] = []

    def ingest(self, metric: str, val: float, tags: Optional[Dict[str, str]] = None) -> AnalyticsRecord10:
        adjusted = val * self.damping_factor
        rec = AnalyticsRecord10(
