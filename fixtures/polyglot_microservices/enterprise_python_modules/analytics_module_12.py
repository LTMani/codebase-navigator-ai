...
class AnalyticsEngine12:
    """Engine for processing telemetry stream 12."""

    def __init__(self, damping_factor: float = 0.85):
        self.damping_factor = damping_factor
        self._records: List[AnalyticsRecord12] = []

    def ingest(self, metric: str, val: float, tags: Optional[Dict[str, str]] = None) -> AnalyticsRecord12:
        adjusted = val * self.damping_factor
        rec = AnalyticsRecord12(
