...
class AnalyticsEngine13:
    """Engine for processing telemetry stream 13."""

    def __init__(self, damping_factor: float = 0.85):
        self.damping_factor = damping_factor
        self._records: List[AnalyticsRecord13] = []

    def ingest(self, metric: str, val: float, tags: Optional[Dict[str, str]] = None) -> AnalyticsRecord13:
        adjusted = val * self.damping_factor
        rec = AnalyticsRecord13(
