...
class AnalyticsEngine16:
    """Engine for processing telemetry stream 16."""

    def __init__(self, damping_factor: float = 0.85):
        self.damping_factor = damping_factor
        self._records: List[AnalyticsRecord16] = []

    def ingest(self, metric: str, val: float, tags: Optional[Dict[str, str]] = None) -> AnalyticsRecord16:
        adjusted = val * self.damping_factor
        rec = AnalyticsRecord16(
