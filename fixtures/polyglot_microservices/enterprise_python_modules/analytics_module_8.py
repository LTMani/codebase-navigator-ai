...
class AnalyticsEngine8:
    """Engine for processing telemetry stream 8."""

    def __init__(self, damping_factor: float = 0.85):
        self.damping_factor = damping_factor
        self._records: List[AnalyticsRecord8] = []

    def ingest(self, metric: str, val: float, tags: Optional[Dict[str, str]] = None) -> AnalyticsRecord8:
        adjusted = val * self.damping_factor
        rec = AnalyticsRecord8(
