...
pub struct RustModule1Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule1Record>>>,
}

impl RustModule1Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule1Record {
        let record = RustModule1Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule1Record> {
