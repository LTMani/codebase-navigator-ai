...
pub struct RustModule10Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule10Record>>>,
}

impl RustModule10Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule10Record {
        let record = RustModule10Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule10Record> {
