...
pub struct RustModule11Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule11Record>>>,
}

impl RustModule11Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule11Record {
        let record = RustModule11Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule11Record> {
