...
pub struct RustModule12Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule12Record>>>,
}

impl RustModule12Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule12Record {
        let record = RustModule12Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule12Record> {
