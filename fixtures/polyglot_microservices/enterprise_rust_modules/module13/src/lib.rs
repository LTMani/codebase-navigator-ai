...
pub struct RustModule13Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule13Record>>>,
}

impl RustModule13Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule13Record {
        let record = RustModule13Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule13Record> {
