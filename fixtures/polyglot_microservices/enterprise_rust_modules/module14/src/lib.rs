...
pub struct RustModule14Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule14Record>>>,
}

impl RustModule14Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule14Record {
        let record = RustModule14Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule14Record> {
