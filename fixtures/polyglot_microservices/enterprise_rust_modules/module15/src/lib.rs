...
pub struct RustModule15Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule15Record>>>,
}

impl RustModule15Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule15Record {
        let record = RustModule15Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule15Record> {
