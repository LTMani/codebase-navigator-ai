...
pub struct RustModule16Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule16Record>>>,
}

impl RustModule16Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule16Record {
        let record = RustModule16Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule16Record> {
