...
pub struct RustModule17Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule17Record>>>,
}

impl RustModule17Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule17Record {
        let record = RustModule17Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule17Record> {
