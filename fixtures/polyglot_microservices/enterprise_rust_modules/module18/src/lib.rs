...
pub struct RustModule18Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule18Record>>>,
}

impl RustModule18Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule18Record {
        let record = RustModule18Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule18Record> {
