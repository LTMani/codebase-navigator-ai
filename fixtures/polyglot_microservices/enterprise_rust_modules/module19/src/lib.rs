...
pub struct RustModule19Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule19Record>>>,
}

impl RustModule19Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule19Record {
        let record = RustModule19Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule19Record> {
