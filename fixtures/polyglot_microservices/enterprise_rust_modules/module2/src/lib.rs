...
pub struct RustModule2Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule2Record>>>,
}

impl RustModule2Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule2Record {
        let record = RustModule2Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule2Record> {
