...
pub struct RustModule20Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule20Record>>>,
}

impl RustModule20Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule20Record {
        let record = RustModule20Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule20Record> {
