...
pub struct RustModule4Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule4Record>>>,
}

impl RustModule4Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule4Record {
        let record = RustModule4Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule4Record> {
