...
pub struct RustModule5Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule5Record>>>,
}

impl RustModule5Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule5Record {
        let record = RustModule5Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule5Record> {
