...
pub struct RustModule6Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule6Record>>>,
}

impl RustModule6Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule6Record {
        let record = RustModule6Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule6Record> {
