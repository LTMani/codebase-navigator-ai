...
pub struct RustModule7Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule7Record>>>,
}

impl RustModule7Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule7Record {
        let record = RustModule7Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule7Record> {
