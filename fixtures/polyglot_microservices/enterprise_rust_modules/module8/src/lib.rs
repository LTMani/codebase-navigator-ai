...
pub struct RustModule8Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule8Record>>>,
}

impl RustModule8Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule8Record {
        let record = RustModule8Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule8Record> {
