...
pub struct RustModule9Engine {
    store: Arc<RwLock<HashMap<Uuid, RustModule9Record>>>,
}

impl RustModule9Engine {
    pub fn new() -> Self {
        Self {
    ...
    pub fn insert_record(&self, title: &str, score: f64) -> RustModule9Record {
        let record = RustModule9Record {
            id: Uuid::new_v4(),
    ...
    pub fn get_record(&self, id: &Uuid) -> Option<RustModule9Record> {
